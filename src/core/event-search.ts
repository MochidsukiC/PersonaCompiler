...
export const eventLabels: Record<LifeEvent['kind'], string> = { move: '施設内移動', travel: '施設間移動', speech: '発話', facility: '施設利用', sleep: '睡眠', wake: '起床', end: '活動終了', entry: '入場', death: '死亡', birth: '出生', marriage: '結婚', home: '新居', organization: '組織', construction: '施設建設' }
